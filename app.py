...
def generate_post(topic):
    ...
    prompt_post = (
        ...
        f"{recent_news}\n\n"
        "Используйте короткие абзацы, подзаголовки, примеры и ключевые слова для лучшего восприятия и SEO-оптимизации. Оформи с учетом того, что это будет опубликовано в Телеграм с выделением bold как на примере: **подзаголовок**"
    )
    try:
